...
public class DemoSystem : MonoBehaviour {
    ...
    public string logCreate(string logDate) {
        string date, log = "";
        ...
        date = "Input:\t" + logDate + "\tTime:\t" + timeC.getTime() + "\tChageUse:\t" + chageCount + "\tBS Use:\t" + BScount.ToString() + "\tLockUse:\t" + LockCount + "\tLockTime:\t" + timeC.getLockTime() + "\n" + "\tWord:\t" + log;
        return date;
    }
